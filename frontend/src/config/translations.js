// translations.js - Button label translations for Cypher Arena
...
const translations = {
  en: {
    ...
    // Control buttons
    nextItem: "Next Item",
    decreaseInterval: "Decrease Interval",
  ...
  pl: {
    ...
    decreaseInterval: "Zmniejsz Interwał",
    increaseInterval: "Zwiększ Interwał",
    pause: "Pauza",
    resume: "Wznów",
